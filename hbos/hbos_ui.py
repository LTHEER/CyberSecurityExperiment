...
from hbos import hbos_test
from hbos.hbos_test_ui import Ui_MainWindowv_test

from hbos_test import run_hbos_test
...
class Ui_MainWindowv_Hbos(object):
    ...
    def setup_Ui_Hbos(self, MainWindowv):
        ...
        self.pb_run.clicked.connect(self.run_function_hbos)
        ...
        self.lineEdit_2.setText(str(0.14))
    ...
    def retranslateUi(self, MainWindowv):
        ...
        self.label.setText(_translate("MainWindowv", "HBOS模型训练"))
    ...
    def goto_model(self):
        ...
        self.ui_mpdel = Ui_MainWindowv_test()
        self.ui_mpdel.setup_Ui_model_hbos(self.model)
        self.model.show()

    def run_function_hbos(self):
        ...
        annomy = float(self.lineEdit_2.text())
        print(raw_data_filename1)
        print(raw_data_filename2)
        print(Frace)
        print(annomy)
        hbos_test.run_hbos_test(raw_data_filename1=raw_data_filename1,
                                raw_data_filename2=raw_data_filename2,
                                Frace=Frace,annomy=annomy)

        self.image()

    def image(self):
        pixmap = QPixmap(self.cwd + "/image/hbos.png")
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindowv_Hbos()
    ui.setup_Ui_Hbos(MainWindowv)
    MainWindowv.show()
    sys.exit(app.exec_())
