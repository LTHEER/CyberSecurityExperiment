...
from hbos_model_test import run_hbos_test
...
class Ui_MainWindowv_test(object):
    ...
    def setup_Ui_model_hbos(self, MainWindowv):
        ...
        self.lineEdit_5.setText(str(0.12))
    ...
    def retranslateUi(self, MainWindowv):
        ...
        self.label.setText(_translate("MainWindowv", "HBOS模型测试"))
    ...
    def test_model(self):
        ...
        Abonmy = float(self.lineEdit_5.text())
        print(Frac)
        print(Abonmy)

        # 入口函数
        run_hbos_test(raw_data_filename1=raw_data_filename1,
                      Frace=Frac,annomy=Abonmy)
    ...
    def image(self):
        pixmap = QPixmap(self.cwd + "/image/hbos_test.png")
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindowv_test()
    ui.setup_Ui_model_hbos(MainWindowv)
    MainWindowv.show()
    sys.exit(app.exec_())
