...
from abod.Fast_abod_model_test import fast_abod_model_test
...
class Ui_MainWindow_model(object):
    ...
    def retranslateUi(self, MainWindowv):
        ...
        self.label.setText(_translate("MainWindowv", "FastABOD模型测试"))
    ...
    def test_model(self):
        ...
        fast_abod_model_test(raw_data_filename1=self.fileName,
                             Frace=Frac, recent_point=20,
    ...
    def image(self):
        pixmap = QPixmap(self.cwd + "/image/fastabod_test.png")
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow_model()
    ui.setupUi_model(MainWindowv)
    MainWindowv.show()
    sys.exit(app.exec_())
