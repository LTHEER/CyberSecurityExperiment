...
class Ui_MainWindowv_LOF(object):
    def __init__(self):
        super(Ui_MainWindowv_LOF).__init__()
        self.filePath = None
        # self.datasize = 20
    ...
    def setupUi_LOF(self, MainWindowv):
        ...
        self.load_class.clicked.connect(self.goto_LOF_model)
        ...
        # self.pb_run.clicked.connect(self.image)
    ...
    def retranslateUi(self, MainWindowv):
        ...
        self.label.setText(_translate("MainWindowv", "LOF模型训练"))
        ...
        self.label_batch.setText(_translate("MainWindowv", "占比"))
        ...
        self.label_epoch.setText(_translate("MainWindowv", "邻域点数"))
    ...
    def goto_LOF_model(self):
        ...
        self.ui_model = Ui_MainWindowv_LOFmodel()
        self.ui_model.setupUi_LOFmodel(self.model)
        self.model.show()
    ...
    def run_function(self):
        ...
        print("----------BEGIN-----------")
        if self.fileName != "":
            raw_data_filename1 = self.load_train_pic_path.text()
            raw_data_filename2 = self.le_save_dir_path.text()
            Frace = float(self.load_xml_path_2.text())
            Domain_Index = int(self.lineEdit.text())
            threshold = float(self.lineEdit_2.text())
            lof_test.run_lof_test(raw_data_filename1=raw_data_filename1,
                                  raw_data_filename2=raw_data_filename2,
                                  Frace=Frace, Domain_Index=Domain_Index, Abnormal_proportion=threshold)
            self.image()
            self.genMastClicked()
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindowv_LOF()
    ui.setupUi_LOF(MainWindowv)
    MainWindowv.show()
    sys.exit(app.exec_())
