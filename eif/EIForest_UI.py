...
class Ui_MainWindow_EIF(object):
    def __init__(self):
        super(Ui_MainWindow_EIF).__init__()
        self.filePath = None
        sys.stdout = EmittingStr(textWritten=self.updatetext)
        sys.stderr = EmittingStr(textWritten=self.updatetext)
        self.cwd = os.path.dirname(os.path.dirname(__file__))

    def setupUi_EIF(self, MainWindowv):
        MainWindowv.setObjectName("孤立森林")
        ...
        self.load_class.clicked.connect(self.goto_EIFmodel_test)

        self.load_model_path = QtWidgets.QLineEdit(self.tab_7)
        self.load_model_path.setStyleSheet("background-color: rgb(207, 207, 207);")
        ...
        self.lineEdit_3.setStyleSheet("background-color: rgb(207, 207, 207);")
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.gridLayout.addWidget(self.lineEdit_3, 2, 4, 1, 1)
        self.lineEdit_3.setText(str(512))
        ...
        self.label_2 = QtWidgets.QPushButton(self.tab_6)
        self.label_2.setStyleSheet("background-color: rgb(175, 177, 255);")
        ...
        self.label_3 = QtWidgets.QPushButton(self.tab_6)
        self.label_3.setStyleSheet("background-color: rgb(175, 177, 255);")
        ...
        self.lineEdit_4.setStyleSheet("background-color: rgb(207, 207, 207);")
    ...
    def retranslateUi(self, MainWindowv):
        ...
        self.label.setText(_translate("MainWindowv", "孤立森林模型训练"))
        self.load_model.setText(_translate("MainWindowv", "模型地址"))
    ...
    def genMastClicked(self):
        ...
        # print(self.filePath)
        # print(self.datasize)
        # print(self.lineEdit_)
        # print(self.lineEdit_2_)
        loop = QEventLoop()
    ...
    def run_function(self):
        ...
        if self.fileName != "":
            ...
            Ntrees = int(self.lineEdit.text())
            Sample_size = int(self.lineEdit_3.text())
            EXtensionLevel = int(self.lineEdit_4.text())
            Anomy = float(self.lineEdit_5.text())
            if int(self.lineEdit_2.text()) == 0:
                Limit = None
            else:
                Limit = int(self.lineEdit_2.text())
            eif_test.eif_run(raw_data_filename1=self.fileName, raw_data_filename2=raw_data_filename2,
                             Frace=Frace, Anomy=Anomy, Ntrees=Ntrees, Sample_size=Sample_size, Limit=Limit,
    ...
    def image(self):
        pixmap = QPixmap(self.cwd + "/image/eif.png")
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow_EIF()
    ui.setupUi_EIF(MainWindowv)
    MainWindowv.show()
    sys.exit(app.exec_())
